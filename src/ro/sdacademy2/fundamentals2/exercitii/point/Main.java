...
public class Main {
    public static void main(String[] args) {
        Point p = new Point();
        System.out.println("P's x value is " + p.getX());
        System.out.println("P's y value is " + p.getY());
        ...
        System.out.println("Distance between points and coordinates is "+p.distance(10,15));

        Point anotherPoint=new Point(45,12);

        System.out.println("Distance between two points "+p.distance(anotherPoint));
    }
